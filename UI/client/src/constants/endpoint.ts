...
const AI_SVC = `${BASE_URL}/api-gateway/ai-service`;
...
const ENDPOINT = {
  ...
  ORDER_PENDING: `${ORDER_SVC}/api/orders/pending`,
  ORDER_CONFIRM: (id: number) => `${ORDER_SVC}/api/orders/${id}/confirm`,
  ...
  CHAT: {
    ...
    AI_HISTORY: `${AI_SVC}/history`,
  },

  // ── AI Service ───────────────────────────────────────────────────────────
  AI: {
    CHAT: `${AI_SVC}/chat`,
    HISTORY: `${AI_SVC}/history`,
  },
