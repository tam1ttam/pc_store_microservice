...
export default function About() {
    ...
    const stats = [
        { value: "10+", label: t('about.stat_years'), icon: Building2 },
        { value: "50+", label: t('about.stat_experts'), icon: Users2 },
        { value: "1000+", label: t('about.stat_projects'), icon: Award },
        { value: "24/7", label: t('about.stat_support'), icon: Wrench },
    ];
