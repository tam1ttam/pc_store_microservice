...
const Home = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-x-hidden">
            ...
            <ProductSlider title={t("home.bestSelling")} type="best-selling" />

            {/* Slider 2: New Arrivals */}
            <ProductSlider title={t("home.products")} type="newest" />

            <section className="container py-14">
                <h2 className="text-2xl font-bold tracking-tight mb-8 text-center">{t("home.categories")}</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 px-2">
                    ...
                    >
                        ...
                        <h3 className="font-semibold">{t("home.processors")}</h3>
                    </Link>
                    <Link
                        className="flex flex-col items-center justify-center p-6 rounded-lg border hover:border-orange-500 hover:text-orange-500 transition-colors"
                        to="/category/storage"
                    >
                        ...
                        <h3 className="font-semibold">{t("home.storage")}</h3>
                    </Link>
                    <Link
                        className="flex flex-col items-center justify-center p-6 rounded-lg border hover:border-orange-500 hover:text-orange-500 transition-colors"
                    ...
                    >
                        ...
                        <h3 className="font-semibold">{t("home.keyboards")}</h3>
                    </Link>
                    <Link
                        className="flex flex-col items-center justify-center p-6 rounded-lg border hover:border-orange-500 hover:text-orange-500 transition-colors"
                        to="/category/mice"
                    >
                        ...
                        <h3 className="font-semibold">{t("home.mice")}</h3>
                    </Link>
                </div>
            </section>
        </div>
