                ...
                <div key={item.id} className="flex items-center gap-3">
                  ...
                  <div className="text-right shrink-0">
                    <p className="text-sm font-semibold text-orange-500">
                      {(item.productPrice * item.quantity).toLocaleString("vi-VN")}Ä‘
                    </p>
                    <p className="text-xs text-muted-foreground">
                      {item.productPrice.toLocaleString("vi-VN")}Ä‘ {t('checkout.perUnit')}
                    </p>
                  </div>
                </div>
              ))}
                ...
                <div className="flex items-center gap-3 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-green-600 font-medium">
                      {t('checkout.discount')} {discountAmount.toLocaleString("vi-VN")}Ä‘
                    </p>
                  </div>
              ...
              <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-sm text-center">{t('checkout.bankTransferLabel') || "Chuyá»ƒn khoáº£n"}</span>
                  </Label>
                </div>
              </RadioGroup>
            </CardContent>
            ...
            <CardContent className="space-y-3">
              ...
              {discountAmount > 0 && (
                <div className="flex justify-between text-sm text-green-600">
                  ...
                  <span>-{discountAmount.toLocaleString("vi-VN")}Ä‘</span>
                </div>
              )}
              <div className="flex justify-between text-sm text-muted-foreground">
                <span>{t('checkout.shippingFee')}</span>
                <span>{t('checkout.freeShipping')}Ä‘</span>
              </div>
              <Separator />
              <div className="flex justify-between items-center font-semibold text-base">
                <span>{t('checkout.totalAmount')}</span>
                <span className="text-orange-500 text-lg">{totalPrice.toLocaleString("vi-VN")}Ä‘</span>
              </div>
              ...
              >
                {isOrdering ? (
                  ...
                  t('checkout.payViaBank') || "Thanh toÃ¡n chuyá»ƒn khoáº£n"
                )}
              </Button>
            </CardContent>
          </Card>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-green-600 font-medium">
                      {v.discountAmount && v.discountAmount > 0
                        ? `${t('checkout.discount')} ${v.discountAmount.toLocaleString("vi-VN")}Ä‘`
