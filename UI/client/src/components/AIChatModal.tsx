    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            ...
            type: "bot",
            content:
                "👋 Xin chào! Tôi là trợ lý AI của iluttmab pc store. Tôi có thể giúp bạn tra cứu thông tin sản phẩm, đơn hàng và thống kê hệ thống. Hãy hỏi tôi bất cứ điều gì!",
            timestamp: new Date()
        }
    ]);
...
const handleSendMessage = async () => {
    ...
    return (
        <>
            ...
            <button
                onClick={onOpen}
                className={`fixed bottom-8 right-2 z-50 w-10 h-10 bg-gradient-to-r from-orange-600 to-orange-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center text-white hover:scale-110 ${
                    isOpen ? "hidden" : ""
                }`}
            >
                ...
                <div className="fixed bottom-8 right-2 z-50 w-96 h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200">
                    ...
                    <div className="bg-gradient-to-r from-orange-600 to-orange-500 text-white p-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <div>
                                <h3 className="font-semibold">iluttmab pc store AI</h3>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                        {messages.map((message) => (
                            ...
                            >
                                {message.type === "user" ? (
                                    <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 bg-orange-600 text-white">
                    ...
                    <div className="p-4 bg-white border-t">
                        <div className="flex gap-2">
                            ...
                            <Button
                                ...
                                className="w-10 h-10 rounded-full bg-gradient-to-r from-orange-600 to-orange-500 hover:opacity-90 p-0"
                            >
